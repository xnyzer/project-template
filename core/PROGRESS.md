...
_No prepared tasks yet. Intake work via `/add-feature`, prepare via `/prep-step`._

---

## Feature ideas (backlog)

_New ideas are intaked via `/add-feature` and get the next F-number. (None pending.)_
